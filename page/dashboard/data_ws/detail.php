...
// $data = mysqli_query($connect, "SELECT * FROM santri WHERE id = $id");
// $san = mysqli_fetch_assoc($data);
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Data Wali Santri <?= $santri1["nama_lengkap"] ?></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="filter d-flex justify-content-between me-4 mx-4 mt-3">
                            <a class="icon" href="data_ws.php"><button class="btn btn-outline-dark"><i class="bi bi-chevron-double-left"></i> Kembali</button></a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-cols-3">
                                <?php
                                $wali_santri = mysqli_query($connect, "SELECT * FROM wali_santri WHERE santri_id = $id");
