        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Data Wali Santri
                        <?= $santri1["nama_lengkap"] ?>
                    </li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="filter mx-4 mt-3">
                            <a class="icon" href="detail.php?id=<?= $santri1["id"] ?>"><button class="btn btn-outline-dark"><i class="bi bi-chevron-double-left"></i>
                                    Kembali</button></a>
                        </div>
                        <div class="card-body">
