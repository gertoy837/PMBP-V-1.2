                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="filter mx-4 mt-3">
                            <a class="icon" href="detail.php?id=<?= $log["id"] ?>"><button class="btn btn-outline-dark"><i class="bi bi-chevron-double-left"></i> Kembali</button></a>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row row-cols-3">
                                    <div class="col">
                                        <div class="card-body">
                                            ...
                                            <input type="text" name="user" class="form-control" id="" value="<?= $log["username"] ?>">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="card-body">
                                            <h5 class="mx-1 fw-bold">Email</h5>
                                            <input type="email" name="email" class="form-control" id="" value="<?= $log["email"] ?>">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="card-body">
                                    ...
                                    <div class="col">
                                        <div class="card-body">
                                            ...
                                            <select class="form-select" name="kat">
                                                ...
                                                <option <?php echo $log['kat_id'] == 1 ? "selected" : "" ?> value="1">Admin</option>
                                                <option <?php echo $log['kat_id'] == 2 ? "selected" : "" ?> value="2">User</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col">
...
if (isset($_POST['simpan'])) {
    $query = "UPDATE login SET username = '$user', email = '$email', password = '$pw', kat_id = '$kat', santri_id = '$st' WHERE id = '$log[id]'";
