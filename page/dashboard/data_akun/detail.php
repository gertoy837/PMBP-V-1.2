...
$santri = mysqli_query($connect, "SELECT * FROM santri WHERE id = '$log[santri_id]'");
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="filter d-flex justify-content-between me-4 mx-4 mt-3">
                            ...
                            <a class="icon" href="edit.php?id=<?= $log["id"] ?>"><button class="btn btn-outline-info"><i class="bi bi-pencil"></i> Edit</button></a>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row row-cols-3">
                                <div class="col">
                                    <div class="card-body">
                                        ...
                                        <div class="img-thumbnail">
                                            <span class="p-2 "><?= $log["username"] ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <div class="card-body">
                                        ...
                                        <div class="img-thumbnail">
                                            <span class="p-2"><?= $log["password"] ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card-body">
                                        ...
                                        <div class="img-thumbnail">
                                            <span class="p-2"><?php echo $log['kat_id'] == 1 ? "Admin" : "User" ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card-body">
                                        ...
                                        <div class="img-thumbnail">
                                            <span class="p-2"><?= $san['nama_lengkap'] ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
