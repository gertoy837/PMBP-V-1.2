                      ...
                      <td>
                        <div class="filter">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow border">
                            ...
                            <li><a class="dropdown-item" href="detail.php?id=<?= $log["id"] ?>">Detail</a></li>
                            <li><a class="dropdown-item" href="edit.php?id=<?= $log["id"] ?>">Edit</a></li>
                            <li><a class="dropdown-item" href="hapus.php?id=<?= $log['id'] ?>" onclick="return confirm('Apakah anda yakin data ini akan dihapus ?')">Hapus</a></li>
                          </ul>
                        </div>
                      </td>
                    </tr>
