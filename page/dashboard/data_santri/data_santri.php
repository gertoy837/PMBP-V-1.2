                      ...
                      <td>
                        <div class="filter">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow border">
                            ...
                            <li><a class="dropdown-item" href="detail.php?id=<?= $san["id"] ?>">Detail</a></li>
                            <li><a class="dropdown-item" href="edit.php?id=<?= $san["id"] ?>">Edit</a></li>
                            <li><a class="dropdown-item" href="hapus.php?id=<?= $san['id'] ?>" onclick="return confirm('Apakah anda yakin data ini akan dihapus ?')">Hapus</a></li>
                          </ul>
                        </div>
                      </td>
                    </tr>
